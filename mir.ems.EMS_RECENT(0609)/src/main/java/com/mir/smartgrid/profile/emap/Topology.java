package com.mir.smartgrid.profile.emap;
...
public class Topology {
	...
	public String toString() {
		...
		try {
			...
			if (getDeviceType().contains("LED")) {
				jsonObject.put("state", getState());
				jsonObject.put("dimming", getDimming());

			} else if (getDeviceType().contains("Solar")) {

				jsonObject.put("state", getState());

			} else if (getDeviceType().contains("Battery")) {
			...
			} else if (getDeviceType().contains("Recloser")) {
